        ...
        <div>
            ...
            <nav className='w-full lg:pt-16 md:pt-10 pt-7'>
                ...
                <div className='justify-between px-5 md:flex md:items-center md:justify-between md:px-11 lg:px-[13.25rem]'>
                    ...
                    <div className={`fixed flex justify-end lg:static top-0 bottom-0 left-0 right-0 bg-black/50 lg:bg-transparent md:backdrop-blur-none backdrop-blur-xl z-[40] lg:block ${navbar ? ' block' : 'hidden'
                        }`}>
